...
urlpatterns = [
    ...
    path('credits/payment-status/<uuid:payment_id>/', CreditPaymentStatusView.as_view(), name='credit-payment-status'),
    path('credits/mpesa-callback/',            MpesaCreditCallbackView.as_view(),   name='credit-mpesa-callback'),
